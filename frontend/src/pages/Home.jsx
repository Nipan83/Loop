...
export default function Home() {
  ...
  if (loading) {
    return <HomeSkeleton categoryCount={6} />;
  }
    ...
    <div className="home">
      <div className="home-hero">
        <div className="hero-content">
          ...
          <p>
            Join the conversation. Ask questions, share ideas, and discover
            insights from a community that cares.
          </p>
          <div className="hero-stats">
            <div className="stat">
              <span className="stat-number">
                {Object.values(topPosts).reduce(
                  (acc, cat) => acc + cat.posts.length,
                  0,
                )}
                +
              </span>
